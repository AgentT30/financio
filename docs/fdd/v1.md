...
- Mark as Matured → Automatically archives (one-step, irreversible)
- View FD detail page
...
- **Status-based Workflow**: active → archived (via "Mark as Matured" action)
...
- **Status Workflow**: Mark as Matured → Auto-archives (irreversible)
